...
Dies äußert sich beim Client in Form einer Fehlermeldung wie zum Beispiel: \enquote{Fehler bei der Authentifizierung}. Auch dem mitgeschnittenen Handshake sieht man dies an  -- der obenstehende Aufruf von \texttt{pyrit} findet diesen zwar, markiert ihn jedoch als \enquote{Bad}, da er nicht erfolgreich durchgeführt wurde.\\
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.95\textwidth]{graphics/aircrack_success}
